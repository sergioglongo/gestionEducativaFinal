...
import { FormControl, Checkbox, Rating, Stack, Box, Grid, Button, FormControlLabel, Typography, Divider } from '@mui/material';
...
export default function NotificationsAdmin() {
    ...
    let notificationsRowsFormated = notificationsState?.map((notification) => {
        ...
        let bodyTrundated = notification?.body?.substring(0,160)
        if (notification?.body.length >160)
        bodyTrundated= bodyTrundated + '...'
        return ([fechaFormated, notification?.subject, bodyTrundated, `${notification.sender?.firstNames} ${notification.sender?.lastName}`,
            <FormControl >
